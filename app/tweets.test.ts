...
test('scraper can get tweet', async () => {
  const expected: Tweet = {
    ...
    html: `We’re updating X’s sounds to help make them pleasing to more people, including those with sensory sensitivities. Here’s more on how we did it:<br><a href=\"https://blog.twitter.com/en_us/topics/product/2022/designing-accessible-sounds-story-behind-our-new-chirps\">https://t.co/7FKWk7NzHM</a>`,
    ...
    photos: [],
    text: 'We’re updating X’s sounds to help make them pleasing to more people, including those with sensory sensitivities. Here’s more on how we did it:\nhttps://t.co/7FKWk7NzHM',
    thread: [],
...
test('scraper can create quote tweet with X API v2', async () => {
  if (shouldSkipV2Tests) {
