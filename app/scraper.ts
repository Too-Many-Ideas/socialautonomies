...
/**
 * An interface to X's undocumented API.
...
export class Scraper {
   ...
   * - Scrapers maintain their own guest tokens for X's internal API.
   * - Reusing Scraper objects is recommended to minimize the time spent authenticating unnecessarily.
   */
  ...
  /**
   * Fetches tweets from a X user using their ID.
  ...
  /**
   * Fetches tweets and replies from a X user.
   * @param user The user whose tweets should be returned.
   * @param maxTweets The maximum number of tweets to return. Defaults to `200`.
   * @returns An {@link AsyncGenerator} of tweets from the provided user.
   */
  ...
  /**
   * Fetches tweets and replies from a X user using their ID.
   * @param userId The user whose tweets should be returned.
   * @param maxTweets The maximum number of tweets to return. Defaults to `200`.
   * @returns An {@link AsyncGenerator} of tweets from the provided user.
   */
  ...
  /**
   * Fetches the most recent tweet from a X user.
  ...
  /**
   * Fetches a single tweet by ID using the X API v2.
  ...
  /**
   * Fetches multiple tweets by IDs using the X API v2.
   * Allows specifying optional expansions and fields for more detailed data.
   *
  ...
  /**
   * Login to X as a real X account. This enables running
   * searches.
   * @param username The username of the X account to login with.
   * @param password The password of the X account to login with.
   ...
   * @deprecated This function no longer represents any part of X's auth flow.
  ...
  /**
   * Logs in to X via Proxsee using the Periscope JWT.
