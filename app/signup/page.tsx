...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-20 left-20 w-64 h-64 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full blur-3xl opacity-20"
        animate={{
          x: [0, 30, 0],
          y: [0, -30, 0],
        }}
      ...
      <motion.div
        className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full blur-3xl opacity-20"
        animate={{
          x: [0, -40, 0],
          y: [0, 40, 0],
        }}
      ...
      <div className="container flex min-h-screen w-screen flex-col items-center justify-center px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            >
              Scale your X presence organically
            </motion.p>
          </motion.div>
          ...
          >
            ...
            >
              <AuthHeader
                ...
                text="Enter your email to get started with Magic Link"
              />
            </motion.div>
